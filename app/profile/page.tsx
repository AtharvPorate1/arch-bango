  ...
  return (
    <div className="relative bg-[#0c0c0c]">
      <Link href={`/discover/${id}`} className="block">
        ...
        >
          <Card className={`bg-[#151419] shadow-none dm-sans border-none rounded-none text-ow1 overflow-hidden transition-all duration-200 group-hover:bg-[] group-hover:text-white ${showEndButton ? 'w-full' : 'w-5/6'}`}>
                ...
                <div className="w-2/3 px-2 py-1 flex flex-col justify-between">
                  ...
                  <div>
                    ...
                    <div className="flex justify-between text-xs text-ow1 mt-2">
                      <span>$0 Vol.</span>
                      <span className="flex items-center"><Users className="h-3 w-3 mr-1" /> 0</span>
                      <span className="flex items-center"><MessageSquare className="h-3 w-3 mr-1" /> 0</span>
                    </div>
                  </div>
                </div>
              </div>
